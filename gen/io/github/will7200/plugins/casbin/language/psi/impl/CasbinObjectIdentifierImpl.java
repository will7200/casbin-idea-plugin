...
import io.github.will7200.plugins.casbin.language.psi.CasbinObjectIdentifier;
...
public class CasbinObjectIdentifierImpl extends ASTWrapperPsiElement implements CasbinObjectIdentifier {

  public CasbinObjectIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
